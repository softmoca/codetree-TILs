...
for t in range(1, m + 1):
    ...
    for i in range(1, p + 1):
        ...
        currentBest = ((closestX - rudolf[0])  + (closestY - rudolf[1]) , (-closestX, -closestY))
        currentValue = ((pos[i][0] - rudolf[0])  + (pos[i][1] - rudolf[1]) , (-pos[i][0], -pos[i][1]))

        if currentValue < currentBest:
            closestX, closestY = pos[i]
            closestIdx = i
    #     print(i,currentBest,currentValue)
    # print()
